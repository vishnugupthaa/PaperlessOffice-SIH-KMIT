...
<body>
    ...
    <div class="jumbotron text-center">
        ...
        <p class="lead">THis is the part where you submit your completed tasks.</p>
        <hr class="my-4">
        <!-- <p>Matter pending to type.</p> -->
        <p class="lead">
            <a class="btn btn-primary btn-lg" href="submittasks.php" role="button">Submit Your Task</a>
        </p>
    </div>
